...
- [ ] **Memory budget:** under a deep stack a layer's resident set stays within its configured per-layer chunk cap; exceeding it forces farthest-first eviction of clean chunks while near and dirty chunks remain pinned; the budget pass introduces no main-thread block and no nondeterminism
