...
// Per-layer chunk visibility and budget management (M3 stub of the full LOD
// system described in docs/ARCHITECTURE.md §9).
//
...
//   - which resident chunks are now far enough to evict (a hysteresis margin
//     beyond the load radius prevents thrashing at the boundary)
//
